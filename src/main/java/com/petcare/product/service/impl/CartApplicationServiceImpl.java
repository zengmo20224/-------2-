...
public class CartApplicationServiceImpl implements CartApplicationService {
    ...
    public CartItemResponse addCartItem(Long currentUserId, CartItemCreateRequest request) {
        ...
        // ID will be generated by MyBatis-Plus ASSIGN_ID; pass null for new inserts
        // For ON DUPLICATE KEY UPDATE, the id is only used for new inserts
        cartItemMapper.upsert(null, currentUserId, request.productId(), request.quantity());
