...
| D-007 文件上传 | 已决定 | JPEG/PNG/WebP, 6 张/帖, 本地目录, 前端压缩 |
| D-008 AI Provider | 已决定 | deepseek-chat, 30s 超时, 1 次重试, 2048 Token, 20 次/天 |
| D-013 用户端 E2E 认证 | 已决定 | 开发环境测试登录端点 |
| D-014 公开读取策略 | 已决定 | 公开资源 GET 全放行 |
